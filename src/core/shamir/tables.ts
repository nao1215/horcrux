/**
 * GF(2^8) finite field arithmetic tables
 * These tables are used for efficient multiplication and division operations
 * in the Galois Field GF(2^8), which is essential for Shamir's Secret Sharing
 */

/**
 * Logarithm table for GF(2^8)
 * Maps field elements to their logarithms
 */
export const logTable = new Uint8Array([
...
/**
 * Exponential table for GF(2^8)
 * Maps logarithms back to field elements
 */
export const expTable = new Uint8Array([
